...
function loadRecords() {
    ...
    window.location.href = "{% url 'projects:project_detail' project.id %}?start=" + startDatetime.format('X') + "&end=" + endDatetime.format('X') + "&uat_type_custom=" + uat_type_custom + "&last_tab=custom";
}
